...
\newcommand{\kurs}{TEU22}
\newcommand{\firma}{TWS Netz GmbH}
\newcommand{\abgabe}{\today}
\newcommand{\betreuerdhbw}{Prof. Dr.-Ing. Konrad Reif}			% Gutachter der DHBW (nur bei Bachelorarbeit erforderlich)
...
\pagenumbering{roman}
%\include{chapter/Überblick_Tätigkeiten_der_Praxisphasen} 
...
\printnomenclature
\clearpage
\renewcommand{\indexname}{Formelzeichenverzeichnis}
